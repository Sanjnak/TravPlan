      ...
      <div className="w-screen h-screen bg-[#e6ffff]">
        <div className="absolute bg-white h-fit w-120 text-[#035199] my-15 mx-auto left-0 right-0 p-10 rounded-lg shadow-xl">
          <form onSubmit={(e) => e.preventDefault()} className="flex flex-col">
            ...
            <button className="bg-[#ffffff] hover:bg-[#e6ffff] mx-5 my-2 p-3 text-md font-semibold rounded-3xl cursor-pointer shadow-lg flex items-center justify-center gap-3"
            ...
            <input
              ...
              className="mx-5 my-2 p-3 border-2 border-gray-400 rounded-sm"
            />
            <p className="text-md text-red-600 p-3 mx-2 font-bold"></p>
            <h1 className="text-left text-md my-1 mx-5 hover:underline">
